...
초기에는 학습 내용을 복습하는 것을 목표로 진행하였고, 이후 상용 커뮤니티 게시판에 필요한 기능은 어떤것들이 있을까 생각하며
기능들을 하나하나 붙여나갔습니다. 단순히 기능을 붙이는 것을 넘어 어떤식으로 동작해야 효율적일지, 어떤식으로 작성해야 깔끔하고 유지보수하기 좋을지  
나름대로 고민하고 개선하려 노력하였습니다.
